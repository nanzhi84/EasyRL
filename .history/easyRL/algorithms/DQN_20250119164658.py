...
class DQN(nn.Module):
    def __init__(self, feature_dim, action_dim, learning_rate=0.01, gamma=0.9, epsilon_start=0.9, epsilon_end=0.1, epsilon_decay=0.995,mmemory_size=500, batch_size=32, replace_target_iter=300):
        ...
        self.eval_net = Network(self.feature_dim, self.action_dim)
        self.target_net = Network(self.feature_dim, self.action_dim)
