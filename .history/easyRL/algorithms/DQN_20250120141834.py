...
class DQN(nn.Module):
    ...
    def decay_epsilon(self):
        ...
        self.epsilon = self.epsilon_min + (self.epsilon - self.epsilon_en'd) * \
            math.exp(-1. * self.memory_counter / self.epsilon_decay)
    ...
    def learn(self, done):
        ...
        q_target = (batch_reward + (1 - done) * self.gamma * q_next.max(dim=1)[0]).unsqueeze(1)
