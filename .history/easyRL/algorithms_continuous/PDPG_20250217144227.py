...
class ActorCritic:
    def __init__(self,
        ...
        self.taget_poliicy_net
        self.value_net = CriticNetwork(feature_dim, action_dim).to(self.device)
        self.taget_value_net = CriticNetwork(feature_dim, action_dim).to(self.device)
    ...
    def _replace_target_params(self):
        ...
        self.taget_policy_net.load_state_dict(self.policy_net.state_dict())
    ...
    def learn(self, done, step_counter):
        ...
        with torch.no_grad():
            next_actions = self.policy_net(next_states_t)
            next_values = self.value_net(next_states_t, next_actions).squeeze()
