...
class DDPG:
    ...
    def learn(self, done, step_counter):
        ...
        with torch.no_grad():
            ...
            q1, q2 = self.target_value_net(next_states_t, next_actions).squeeze()
            next_values = torch.min(q1, q2)
        ...
        value_loss = nn.MSELoss()(current_q1, targets) + nn.MSELoss()(current_q2, ta)
