...
import torch
from easyRL.algorithms import DQN, DDQN, DUELING_DDQN, REINFORCE, PER_DDQN, PPO
...
class Config:
    ...
    clip_epsilon=0.2,                   # PPO算法中用于限制策略更新幅度的裁剪参数
    ppo_epochs=4,                       # PPO算法中每次更新时进行梯度更新的轮数
    gae_lambda=0.95                     # 广义优势估计(GAE)中的λ参数
